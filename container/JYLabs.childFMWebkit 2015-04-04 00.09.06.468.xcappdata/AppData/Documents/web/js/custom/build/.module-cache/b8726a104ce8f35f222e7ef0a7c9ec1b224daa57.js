...
var PlayerContainerInstance = React.createElement(PlayerContainer, {dataUrl: "../data/playlist.json"}) ;
React.renderComponent(PlayerContainerInstance);
/*
* play list
* */
