...
var PlayList = React.createClass({displayName: "PlayList",
    ...
    render : function(){
        console.log(this.props.data[activeMode].playList);
    ...
    render : function(){
        ...
        for (var modeKey in self.data)
        {
            ...
            ModeListItemNodes.push(
                React.createElement(ModeListItem, {data: self.data[modeKey], active: active, modeKey: modeKey, key: modeKey, onSwitchMode: self.handleSwitchMode})
            );
        }
