    ...
    render : function(){
        ...
        for (var modeKey in self.state.playList)
        {
            ...
            ModeListItemNodes.push(
                React.createElement(ModeListItem, {data: {data:self.state.playList[modeKey]}, active: active, key: modeKey, onSwitchMode: self.handleSwitchMode})
            );
        }
