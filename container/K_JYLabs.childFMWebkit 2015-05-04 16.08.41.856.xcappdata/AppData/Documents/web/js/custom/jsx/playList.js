    ...
    render : function(){
        return (
            <div className="player-container">
                ...
                <PlayList data={this.state.playListData[this.state.modeKey]} modeKey={this.state.modeKey} playIndex={this.state.playIndex} playing={this.state.playing}/>
...
var PlayList = React.createClass({
    ...
    render : function(){
        ...
        var PlayListItemNodes = this.props.data.playList.map(function(playListDataItem,index){
            return (
                <PlayListItem key={index} data={playListDataItem} active={self.props.playIndex === index ? true : false} playing={self.props.playing}/>
            );
        });
        ...
        return (
            <div className={classes}>
                ...
                <div className="control">
                    <div className={playButtonClasses} onClick={this.switchPlayState}></div>

                    <div className="control-item right play-button fa fa-trash-o"></div>
                    <div className="control-item right play-button fa fa-heart-o"></div>
                </div>
            </div>
        );
    }
