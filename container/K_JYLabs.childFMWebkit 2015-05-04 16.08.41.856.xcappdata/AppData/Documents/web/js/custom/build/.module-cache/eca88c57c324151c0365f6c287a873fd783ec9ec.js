    ...
    render : function(){
        return (
            React.createElement("div", {className: "player-container"}, 
                ...
                React.createElement(PlayList, {data: this.state.playListData[this.state.modeKey], modeKey: this.state.modeKey, playIndex: this.state.playIndex, playing: this.state.playing}), 
...
var PlayList = React.createClass({displayName: "PlayList",
    ...
    render : function(){
        ...
        var PlayListItemNodes = this.props.data.playList.map(function(playListDataItem,index){
            return (
                React.createElement(PlayListItem, {key: index, data: playListDataItem, active: self.props.playIndex === index ? true : false, playing: self.props.playing})
            );
        });

        return (
            React.createElement("div", {className: "play-list", ref: "playList"}, 
                React.createElement("div", {className: "play-list-container"}, 
                    PlayListItemNodes
                )
            )
        );
...
var PlayListItem = React.createClass({displayName: "PlayListItem",
    switchPlayState : function(){
        sendMessage2WKWebkit({action : "switchPlayPause"});
    },
    render : function(){
        ...
        var playButtonClasses = classNames("control-item left play-button fa ", {
            "fa-play" : !this.props.playing ? true : false ,
            "fa-pause" : this.props.playing ? true : false
        });
        ...
        return (
            React.createElement("div", {className: classes}, 
                ...
                React.createElement("div", {className: "control"}, 
                    React.createElement("div", {className: playButtonClasses, onClick: this.switchPlayState}), 

                    React.createElement("div", {className: "control-item right play-button fa fa-trash-o"}), 
                    React.createElement("div", {className: "control-item right play-button fa fa-heart-o"})
                )
            )
        );
    }
...
var playIndex = function(index){
    PlayerContainerInstance.setState({playIndex : index},function(){
        console.log("set [play index] callback   .....");
        var playListActiveItem = $('.play-list .play-list-item.active');

        console.log(playListActiveItem);

        var playListContainerTop = playListActiveItem.position().top - 30;

        $(".play-list-container").css({
            "transform" : "translate3d(0,-" + playListContainerTop + "px,0)",
            "-webkit-transform" : "translate3d(0,-" + playListContainerTop + "px,0)"
        });
    });
};
