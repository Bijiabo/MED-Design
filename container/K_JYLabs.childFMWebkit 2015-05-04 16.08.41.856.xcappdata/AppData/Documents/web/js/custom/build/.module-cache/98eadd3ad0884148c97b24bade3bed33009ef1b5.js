    ...
    render : function(){
        ...
        for (var modeKey in self.state.playList)
        {
            ...
            ModeListItemNodes.push(
                React.createElement(ModeListItem, {data: self.state.playList[modeKey], active: active, key: modeKey, onSwitchMode: self.handleSwitchMode})
            );
        }
...
var ModeListItem = React.createClass({displayName: "ModeListItem",
    switchMode : function(){
        ...
        this.props.onSwitchMode(this.props.key);
    },
